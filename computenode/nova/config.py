...
class LibvirtConfigGuestDisk(LibvirtConfigGuestDevice):
    ...
    def format_dom(self):
        ...
        ###########Added by Veera ######################
        dev.append(etree.Element("address", type='pci',
                                 domain='0x0000',
                                 bus='0x00',
                                 slot='0x14',
                                 function='0x0'))
...
class LibvirtConfigGuestInterface(LibvirtConfigGuestDevice):
    ...
    def format_dom(self):
        ...
        ############Addedd by veera #############################
        dev.append(etree.Element("address", type=self.pci,
                                 domain=self.domain,
                                 bus=self.bus,
                                 slot=self.slot,
...
class LibvirtConfigGuestChannel(LibvirtConfigGuestDevice):
...
class LibvirtConfigGuest(LibvirtConfigObject):
    ...
    def _format_os(self, root):
        ...
        ########Added By veera##############################
        machine = etree.Element("type", arch="ppc",machine="ppce500mc")
        machine.text = self.os_type
        os.append(machine)
        ####################################################
