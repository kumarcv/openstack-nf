...
class IndexView(tables.DataTableView):
    ...
    template_name = 'nova/categories/index.html'
    ...
    def get_data(self):
		...
		networkfunction = ''
		#setattr(category, 'veera', '1000')
		category_id = category.id
		cat_net_maps = api.quantum.category_networkfunction_list(self.request,
                                                           category_id=category_id)
		for cat_net_map in cat_net_maps:
		    net_id = cat_net_map.networkfunction_id
		    net_info = api.quantum.networkfunction_get(self.request,
                                                           net_id)
		    networkfunction += net_info.name+","
		  
		setattr(category, 'networkfunction', networkfunction)
...
class CreateCategoryView(forms.ModalFormView):
    ...
    template_name = 'nova/categories/create.html'
    success_url = reverse_lazy('horizon:nova:categories:index')
...
class UpdateCategoryView(forms.ModalFormView):
    ...
    template_name = 'nova/categories/update.html'
