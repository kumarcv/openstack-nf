...
INDEX_URL = reverse('horizon:nova:chains:index')
...
class NetworkTests(test.TestCase):
    ...
    def test_index(self):
        api.quantum.network_list(
            ...
            shared=False).AndReturn(self.chains.list())
        api.quantum.network_list(
            IsA(http.HttpRequest),
        ...
        self.assertTemplateUsed(res, 'nova/chains/index.html')
        chains = res.context['chains_table'].data
        self.assertItemsEqual(chains, self.chains.list())
    ...
    def test_index_network_list_exception(self):
        ...
        self.assertTemplateUsed(res, 'nova/chains/index.html')
        self.assertEqual(len(res.context['chains_table'].data), 0)
    ...
    def test_network_detail(self):
        network_id = self.chains.first().id
        api.quantum.network_get(IsA(http.HttpRequest), network_id)\
            .AndReturn(self.chains.first())
        ...
        res = self.client.get(reverse('horizon:nova:chains:detail',
                                      args=[network_id]))

        self.assertTemplateUsed(res, 'nova/chains/detail.html')
    ...
    def test_network_detail_network_exception(self):
        ...
        url = reverse('horizon:nova:chains:detail', args=[network_id])
    ...
    def test_network_create_get(self):
        ...
        url = reverse('horizon:nova:chains:create')
        res = self.client.get(url)

        workflow = res.context['workflow']
        self.assertTemplateUsed(res, 'nova/chains/create.html')
    ...
    def test_network_update_get(self):
        ...
        url = reverse('horizon:nova:chains:update', args=[network.id])
        res = self.client.get(url)

        self.assertTemplateUsed(res, 'nova/chains/update.html')
    ...
    def test_delete_network_no_subnet(self):
        ...
        form_data = {'action': 'chains__delete__%s' % network.id}
    ...
    def test_subnet_detail(self):
        ...
        res = self.client.get(reverse('horizon:nova:chains:subnets:detail',
                                      args=[subnet.id]))

        self.assertTemplateUsed(res, 'nova/chains/subnets/detail.html')
    ...
    def test_subnet_create_get(self):
        ...
        url = reverse('horizon:nova:chains:addsubnet',
                      args=[network.id])
        res = self.client.get(url)

        self.assertTemplateUsed(res, 'nova/chains/subnets/create.html')
    ...
    def test_subnet_create_post(self):
        ...
        self.assertNoFormErrors(res)
        redir_url = reverse('horizon:nova:chains:detail',
                            args=[subnet.network_id])
        self.assertRedirectsNoFollow(res, redir_url)
    ...
    def test_subnet_update_post(self):
        ...
        formData = {'network_id': subnet.network_id,
                    ...
                    'ip_version': subnet.ip_version,
                    'gateway_ip': subnet.gateway_ip}
        url = reverse('horizon:nova:chains:editsubnet',
    ...
    def test_subnet_delete(self):
        ...
        url = reverse('horizon:nova:chains:detail',
                      args=[network_id])
        res = self.client.post(url, formData)
    ...
    def test_port_detail(self):
        ...
        res = self.client.get(reverse('horizon:nova:chains:ports:detail',
                                      args=[port.id]))

        self.assertTemplateUsed(res, 'nova/chains/ports/detail.html')
