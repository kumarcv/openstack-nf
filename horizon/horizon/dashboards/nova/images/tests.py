...
class NetworkTests(test.TestCase):
    ...
    def test_index(self):
        api.quantum.network_list(
            ...
            shared=False).AndReturn(self.images.list())
        api.quantum.network_list(
            IsA(http.HttpRequest),
        ...
        self.assertItemsEqual(images, self.images.list())
    ...
    def test_index_network_list_exception(self):
        ...
        self.assertTemplateUsed(res, 'nova/images/index.html')
        self.assertEqual(len(res.context['images_table'].data), 0)
    ...
    def test_network_detail(self):
        network_id = self.images.first().id
        ...
        res = self.client.get(reverse('horizon:nova:images:detail',
                                      args=[network_id]))

        self.assertTemplateUsed(res, 'nova/images/detail.html')
    ...
    def test_network_detail_network_exception(self):
        ...
        url = reverse('horizon:nova:images:detail', args=[network_id])
    ...
    def test_network_create_get(self):
        ...
        url = reverse('horizon:nova:images:create')
        res = self.client.get(url)

        workflow = res.context['workflow']
        self.assertTemplateUsed(res, 'nova/images/create.html')
    ...
    def test_network_update_get(self):
        ...
        url = reverse('horizon:nova:images:update', args=[network.id])
        res = self.client.get(url)

        self.assertTemplateUsed(res, 'nova/images/update.html')
    ...
    def test_delete_network_no_subnet(self):
        ...
        form_data = {'action': 'images__delete__%s' % network.id}
    ...
    def test_subnet_detail(self):
        ...
        res = self.client.get(reverse('horizon:nova:images:subnets:detail',
                                      args=[subnet.id]))

        self.assertTemplateUsed(res, 'nova/images/subnets/detail.html')
    ...
    def test_subnet_create_get(self):
        ...
        url = reverse('horizon:nova:images:addsubnet',
                      args=[network.id])
        res = self.client.get(url)

        self.assertTemplateUsed(res, 'nova/images/subnets/create.html')
    ...
    def test_subnet_create_post(self):
        ...
        self.assertNoFormErrors(res)
        redir_url = reverse('horizon:nova:images:detail',
                            args=[subnet.network_id])
        self.assertRedirectsNoFollow(res, redir_url)
    ...
    def test_subnet_update_post(self):
        ...
        formData = {'network_id': subnet.network_id,
                    ...
                    'ip_version': subnet.ip_version,
                    'gateway_ip': subnet.gateway_ip}
        url = reverse('horizon:nova:images:editsubnet',
    ...
    def test_subnet_delete(self):
        ...
        url = reverse('horizon:nova:images:detail',
                      args=[network_id])
        res = self.client.post(url, formData)
    ...
    def test_port_detail(self):
        ...
        res = self.client.get(reverse('horizon:nova:images:ports:detail',
                                      args=[port.id]))

        self.assertTemplateUsed(res, 'nova/images/ports/detail.html')
