...
class CreateImageInfoAction(workflows.Action):
    ...
    def populate_category_choices(self, request, context):
        try:
            ...
            categories = api.quantum.category_list_for_tenant(request, tenant_id)
    ...
    def populate_vendor_choices(self, request, context):
        try:
            tenant_id = self.request.user.tenant_id
            vendors = api.quantum.vendor_list_for_tenant(request, tenant_id)
...
class CreateImageInfo(workflows.Step):
    ...
    contributes = ("image_name", "image_id", "flavor", "category", "vendor", "security_group")
...
class CreateImage(workflows.Workflow):
    ...
    success_url = "horizon:nova:images:index"
