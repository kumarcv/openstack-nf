...
INDEX_URL = reverse('horizon:syspanel:categories:index')
...
class NetworkTests(test.TestCase):
    ...
    def test_index(self):
        api.quantum.network_list(
            ...
            shared=False).AndReturn(self.categories.list())
        api.quantum.network_list(
            IsA(http.HttpRequest),
        ...
        self.assertTemplateUsed(res, 'syspanel/categories/index.html')
        categories = res.context['categories_table'].data
        self.assertItemsEqual(categories, self.categories.list())
    ...
    def test_index_network_list_exception(self):
        ...
        self.assertTemplateUsed(res, 'syspanel/categories/index.html')
        self.assertEqual(len(res.context['categories_table'].data), 0)
    ...
    def test_network_detail(self):
        network_id = self.categories.first().id
        api.quantum.network_get(IsA(http.HttpRequest), network_id)\
            .AndReturn(self.categories.first())
        ...
        res = self.client.get(reverse('horizon:syspanel:categories:detail',
                                      args=[network_id]))

        self.assertTemplateUsed(res, 'syspanel/categories/detail.html')
    ...
    def test_network_detail_network_exception(self):
        ...
        url = reverse('horizon:syspanel:categories:detail', args=[network_id])
    ...
    def test_network_create_get(self):
        ...
        url = reverse('horizon:syspanel:categories:create')
        res = self.client.get(url)

        workflow = res.context['workflow']
        self.assertTemplateUsed(res, 'syspanel/categories/create.html')
    ...
    def test_network_update_get(self):
        ...
        url = reverse('horizon:syspanel:categories:update', args=[network.id])
        res = self.client.get(url)

        self.assertTemplateUsed(res, 'syspanel/categories/update.html')
    ...
    def test_delete_network_no_subnet(self):
        ...
        form_data = {'action': 'categories__delete__%s' % network.id}
    ...
    def test_subnet_detail(self):
        ...
        res = self.client.get(reverse('horizon:syspanel:categories:subnets:detail',
                                      args=[subnet.id]))

        self.assertTemplateUsed(res, 'syspanel/categories/subnets/detail.html')
    ...
    def test_subnet_create_get(self):
        ...
        url = reverse('horizon:syspanel:categories:addsubnet',
                      args=[network.id])
        res = self.client.get(url)

        self.assertTemplateUsed(res, 'syspanel/categories/subnets/create.html')
    ...
    def test_subnet_create_post(self):
        ...
        self.assertNoFormErrors(res)
        redir_url = reverse('horizon:syspanel:categories:detail',
                            args=[subnet.network_id])
        self.assertRedirectsNoFollow(res, redir_url)
    ...
    def test_subnet_update_post(self):
        ...
        formData = {'network_id': subnet.network_id,
                    ...
                    'ip_version': subnet.ip_version,
                    'gateway_ip': subnet.gateway_ip}
        url = reverse('horizon:syspanel:categories:editsubnet',
    ...
    def test_subnet_delete(self):
        ...
        url = reverse('horizon:syspanel:categories:detail',
                      args=[network_id])
        res = self.client.post(url, formData)
    ...
    def test_port_detail(self):
        ...
        res = self.client.get(reverse('horizon:syspanel:categories:ports:detail',
                                      args=[port.id]))

        self.assertTemplateUsed(res, 'syspanel/categories/ports/detail.html')
