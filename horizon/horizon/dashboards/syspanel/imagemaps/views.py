...
class IndexView(tables.DataTableView):
    ...
    template_name = 'syspanel/imagemaps/index.html'
...
class CreateImageView(workflows.WorkflowView):
    ...
    template_name = 'syspanel/imagemaps/create.html'
...
class UpdateImageView(forms.ModalFormView):
    ...
    template_name = 'syspanel/imagemaps/update.html'
    context_object_name = 'image'
    success_url = reverse_lazy("horizon:syspanel:imagemaps:index")
...
class DetailImageView(tabs.TabView):
    ...
    template_name = 'syspanel/imagemaps/detail.html'
