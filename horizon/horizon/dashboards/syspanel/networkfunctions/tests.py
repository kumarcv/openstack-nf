...
INDEX_URL = reverse('horizon:syspanel:networkfunctions:index')
...
class NetworkTests(test.TestCase):
    ...
    def test_index(self):
        api.quantum.network_list(
            ...
            shared=False).AndReturn(self.networkfunctions.list())
        api.quantum.network_list(
            IsA(http.HttpRequest),
        ...
        self.assertTemplateUsed(res, 'syspanel/networkfunctions/index.html')
        networkfunctions = res.context['networkfunctions_table'].data
        self.assertItemsEqual(networkfunctions, self.networkfunctions.list())
    ...
    def test_index_network_list_exception(self):
        ...
        self.assertTemplateUsed(res, 'syspanel/networkfunctions/index.html')
        self.assertEqual(len(res.context['networkfunctions_table'].data), 0)
    ...
    def test_network_detail(self):
        network_id = self.networkfunctions.first().id
        api.quantum.network_get(IsA(http.HttpRequest), network_id)\
            .AndReturn(self.networkfunctions.first())
        ...
        res = self.client.get(reverse('horizon:syspanel:networkfunctions:detail',
                                      args=[network_id]))

        self.assertTemplateUsed(res, 'syspanel/networkfunctions/detail.html')
    ...
    def test_network_detail_network_exception(self):
        ...
        url = reverse('horizon:syspanel:networkfunctions:detail', args=[network_id])
    ...
    def test_network_create_get(self):
        ...
        url = reverse('horizon:syspanel:networkfunctions:create')
        res = self.client.get(url)

        workflow = res.context['workflow']
        self.assertTemplateUsed(res, 'syspanel/networkfunctions/create.html')
    ...
    def test_network_create_post(self):
        network = self.networkfunctions.first()
    ...
    def test_network_update_get(self):
        ...
        url = reverse('horizon:syspanel:networkfunctions:update', args=[network.id])
        res = self.client.get(url)

        self.assertTemplateUsed(res, 'syspanel/networkfunctions/update.html')
    ...
    def test_delete_network_no_subnet(self):
        ...
        form_data = {'action': 'networkfunctions__delete__%s' % network.id}
    ...
    def test_subnet_detail(self):
        ...
        res = self.client.get(reverse('horizon:syspanel:networkfunctions:subnets:detail',
                                      args=[subnet.id]))

        self.assertTemplateUsed(res, 'syspanel/networkfunctions/subnets/detail.html')
    ...
    def test_subnet_create_get(self):
        ...
        url = reverse('horizon:syspanel:networkfunctions:addsubnet',
                      args=[network.id])
        res = self.client.get(url)

        self.assertTemplateUsed(res, 'syspanel/networkfunctions/subnets/create.html')
    ...
    def test_subnet_create_post(self):
        ...
        self.assertNoFormErrors(res)
        redir_url = reverse('horizon:syspanel:networkfunctions:detail',
                            args=[subnet.network_id])
        self.assertRedirectsNoFollow(res, redir_url)
    ...
    def test_subnet_update_post(self):
        ...
        formData = {'network_id': subnet.network_id,
                    ...
                    'ip_version': subnet.ip_version,
                    'gateway_ip': subnet.gateway_ip}
        url = reverse('horizon:syspanel:networkfunctions:editsubnet',
    ...
    def test_subnet_delete(self):
        ...
        url = reverse('horizon:syspanel:networkfunctions:detail',
                      args=[network_id])
        res = self.client.post(url, formData)
    ...
    def test_port_detail(self):
        ...
        res = self.client.get(reverse('horizon:syspanel:networkfunctions:ports:detail',
                                      args=[port.id]))

        self.assertTemplateUsed(res, 'syspanel/networkfunctions/ports/detail.html')
