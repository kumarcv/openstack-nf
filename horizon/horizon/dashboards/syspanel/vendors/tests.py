...
INDEX_URL = reverse('horizon:syspanel:vendors:index')
...
class NetworkTests(test.TestCase):
    ...
    def test_index(self):
        api.quantum.network_list(
            ...
            shared=False).AndReturn(self.vendors.list())
        api.quantum.network_list(
            IsA(http.HttpRequest),
        ...
        self.assertTemplateUsed(res, 'syspanel/vendors/index.html')
        vendors = res.context['vendors_table'].data
        self.assertItemsEqual(vendors, self.vendors.list())
    ...
    def test_index_network_list_exception(self):
        ...
        self.assertTemplateUsed(res, 'syspanel/vendors/index.html')
        self.assertEqual(len(res.context['vendors_table'].data), 0)
    ...
    def test_network_detail(self):
        network_id = self.vendors.first().id
        api.quantum.network_get(IsA(http.HttpRequest), network_id)\
            .AndReturn(self.vendors.first())
        ...
        res = self.client.get(reverse('horizon:syspanel:vendors:detail',
                                      args=[network_id]))

        self.assertTemplateUsed(res, 'syspanel/vendors/detail.html')
    ...
    def test_network_detail_network_exception(self):
        ...
        url = reverse('horizon:syspanel:vendors:detail', args=[network_id])
    ...
    def test_network_create_get(self):
        ...
        url = reverse('horizon:syspanel:vendors:create')
        res = self.client.get(url)

        workflow = res.context['workflow']
        self.assertTemplateUsed(res, 'syspanel/vendors/create.html')
    ...
    def test_network_update_get(self):
        ...
        url = reverse('horizon:syspanel:vendors:update', args=[network.id])
        res = self.client.get(url)

        self.assertTemplateUsed(res, 'syspanel/vendors/update.html')
    ...
    def test_delete_network_no_subnet(self):
        ...
        form_data = {'action': 'vendors__delete__%s' % network.id}
    ...
    def test_subnet_detail(self):
        ...
        res = self.client.get(reverse('horizon:syspanel:vendors:subnets:detail',
                                      args=[subnet.id]))

        self.assertTemplateUsed(res, 'syspanel/vendors/subnets/detail.html')
    ...
    def test_subnet_create_get(self):
        ...
        url = reverse('horizon:syspanel:vendors:addsubnet',
                      args=[network.id])
        res = self.client.get(url)

        self.assertTemplateUsed(res, 'syspanel/vendors/subnets/create.html')
    ...
    def test_subnet_create_post(self):
        ...
        self.assertNoFormErrors(res)
        redir_url = reverse('horizon:syspanel:vendors:detail',
                            args=[subnet.network_id])
        self.assertRedirectsNoFollow(res, redir_url)
    ...
    def test_subnet_update_post(self):
        ...
        formData = {'network_id': subnet.network_id,
                    ...
                    'ip_version': subnet.ip_version,
                    'gateway_ip': subnet.gateway_ip}
        url = reverse('horizon:syspanel:vendors:editsubnet',
    ...
    def test_subnet_delete(self):
        ...
        url = reverse('horizon:syspanel:vendors:detail',
                      args=[network_id])
        res = self.client.post(url, formData)
    ...
    def test_port_detail(self):
        ...
        res = self.client.get(reverse('horizon:syspanel:vendors:ports:detail',
                                      args=[port.id]))

        self.assertTemplateUsed(res, 'syspanel/vendors/ports/detail.html')
