...
class IndexView(tables.DataTableView):
    ...
    template_name = 'syspanel/vendors/index.html'
...
class CreateVendorView(forms.ModalFormView):
    ...
    template_name = 'syspanel/vendors/create.html'
    success_url = reverse_lazy('horizon:syspanel:vendors:index')
    
class UpdateVendorView(forms.ModalFormView):
    form_class = UpdateVendor
    template_name = 'syspanel/vendors/update.html'
