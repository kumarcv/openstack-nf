...
class APIRouter(wsgi.Router):
    ...
    def __init__(self, **local_config):
        ...
        resources = {'network': 'networks',
                     ...
                     'vip': 'vips',
                     'session': 'sessions',
                     'networkfunction': 'networkfunctions',
                     'category': 'categories',
                     'category_networkfunction': 'category_networkfunctions',
                     'vendor': 'vendors',
                     'image': 'images',
                     'metadata': 'metadatas',
                     'personality': 'personalities',
                     'chain': 'chains',
                     'chain_image': 'chain_images',
                     'chain_image_network': 'chain_image_networks',
                     'chain_image_conf': 'chain_image_confs',
                     'config_handle': 'config_handles',
                     'config': 'configs',
                     'launch': 'launchs'}
