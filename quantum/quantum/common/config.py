...
core_opts = [
    ...
    cfg.ListOpt('service_plugins',default = []),   # (Trinath) added to support service plugins config in quantum.conf
...
slb_scheduler_opts = [
        cfg.StrOpt('loadbalancer_driver',default='Fake'), # (trinath) added to support Service drivers config
]

nws_scheduler_opts = [
        cfg.StrOpt('nwservice_driver',default='Fake'), # (trinath) added to support Service drivers config
...
# Register the Scheduler driver options 
# (trinath)
cfg.CONF.register_opts(slb_scheduler_opts, "DRIVER")
cfg.CONF.register_opts(nws_scheduler_opts, "NWSDRIVER")
